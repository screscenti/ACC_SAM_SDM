...
uint8_t  Cla_Discrete_findTransferFuncCoeffs(double Array[10], double arrayDes[11]) 
{
  ...
  count = Cla_Discrete_noOfCoefficients(Array);
  {
    for ( j = 0 ; j < count; j++ )
    {
      /* 
...
{
  {
    ...
    ___id->__anyPreconditionFailed = false;
    {
      ...
      __assertCondition = ___id->Denominator[0] != 0.0;
...
{
  {
    ...
    {
      bool __assertCondition;
      __assertCondition = (___id->NumDelays <= 10U) && (___id->NumDelays > 0U);
      if ( !__assertCondition ) 
      {
...
{
  {
    ...
    {
      bool __assertCondition;
      __assertCondition = (___id->InitialCondition <= ___id->UpperSaturationLimit) && (___id->InitialCondition >= ___id->LowerSaturationLimit);
      if ( !__assertCondition ) 
      {
    ...
    {
      bool __assertCondition;
      __assertCondition = ___id->LowerSaturationLimit < ___id->UpperSaturationLimit;
      if ( !__assertCondition ) 
      {
...
void  Cla_Discrete____DiscreteIIRFilter_execute(Cla_Discrete____DiscreteIIRFilter_data_t *___id, double in1, double *out1) 
{
  ...
  {
    bool __assertCondition;
    __assertCondition = ___id->countN <= 10U;
    if ( !__assertCondition ) 
    {
  ...
  {
    bool __assertCondition;
    __assertCondition = ___id->countD == ___id->countN;
    if ( !__assertCondition ) 
    {
...
void  Cla_Discrete____DiscreteFIRfilter_execute(Cla_Discrete____DiscreteFIRfilter_data_t *___id, double in1, double *out1) 
{
  ...
  {
    bool __assertCondition;
    __assertCondition = (___id->count - 1) <= 10;
    if ( !__assertCondition ) 
    {
      ___id->__preconditionFailed_FilterOrder = true;
...
void  Cla_Discrete____DiscreteTransferFcn_execute(Cla_Discrete____DiscreteTransferFcn_data_t *___id, double in1, double *out1) 
{
  ...
  j = 0;
  computedValue = 0.0;
  inHisIndex = (___id->countN - ___id->countD);
