 ...
 */
typedef void ((*(BlockInterfaces____ssd_safe_distance_computationInterface_hatchback_executeFunctionTypedef))(void *,double ,double ,double *));
/* 
 * This computes the safe distance between the ACC and leading vehicle
 */
typedef void ((*(BlockInterfaces____ssd_safe_distance_computationInterface_hatchback_updateFunctionTypedef))(void *,double ,double ));
/* 
